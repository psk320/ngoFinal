...
body {
	/* position: relative;*/
	background:
		url(file:///C:/ngomanagementpro/src/main/webapp/WEB-INF/views/images/b1.jpg);
		...
		<div class="art-right-w3ls">
			...
			<form action="login" method="post">
				...
				<div class="right-side-forget">
					<a href="forgotpage.jsp" class="for">Forgot password...?</a>
				</div>
				<div class="clear"></div>
				<div class="btnn">
			...
			<div class="w3layouts_more-buttn">
				<h3>
					Don't Have an account..? <a
						href="http://localhost:8086/ngomanagementpro/user/list"><br>
					<u>Sign Up Here as user</u> </a> <a
						href="http://localhost:8086/ngomanagementpro/ngo/list"><u>
							Sign Up Here as ngo</u> </a>
				</h3>
			</div>
			<!-- popup-->
