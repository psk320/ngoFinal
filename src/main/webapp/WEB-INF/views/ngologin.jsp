		...
		<div class="main-w3l">
			...
			<div class="w3layouts-main">
				<h2><span>Register now</span></h2>
					<form:form action="saveNgo" method="post" modelAttribute="ngo">
						...
						<form:input placeholder="Date" name="date" type="text" required="" path="date"/>
						...
						<form:button type="submit" value="register" name="login">register</form:button>
					</form:form>
			</div>
			<!-- //main -->
